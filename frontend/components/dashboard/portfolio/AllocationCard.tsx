    ...
    >
      ...
      <div className="relative flex items-center justify-between">
        <div>
          ...
          <p className="mt-0.5 text-xs text-slate-400">Sector & stock-level breakdown</p>
        </div>
        <motion.div
          whileHover={{ rotate: 8 }}
      ...
      {/* Placeholder */}
      <div className="relative mt-8 flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 bg-white/[0.02] py-16">
